...
class WhatsAppService:
    ...
    def _get_twilio_client():
        ...
        client = (
            Client(account_sid, auth_token, http_client=http_client)
            if http_client
...
{receipt_line}
Your receipt has been sent to your email. If you have any questions, please contact us at +254142530781.
...
📍 Kimathi House, Fifth Floor, Room 504"""
            ...
            logger.info(
                f"WhatsApp receipt sent to {formatted_phone} for order {order_id}. Message SID: {message.sid}"
            )
            return True
...
If you have any questions, contact us at +254142530781.
...
Affordable Gadgets Team"""
            ...
            logger.info(
                f"WhatsApp receipt with PDF sent to {formatted_phone} for order {order_id}. Message SID: {message.sid}"
            )
            return True
