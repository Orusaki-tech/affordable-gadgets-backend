...
class TestOpenAPIContractPublicEndpoints:
    ...
    def test_products_list_endpoint_documented(self, openapi_spec):
        ...
        has_products = any(
            'products' in path and 'get' in paths[path]
...
class TestOpenAPISchemaConsistency:
    ...
    def test_required_schemas_present(self, openapi_spec):
        ...
        important_schemas = [
            'Product', 'ProductArticle', 'Order', 'InventoryUnit'
        ]
            ...
            for method, details in methods.items():
                if method in ['post', 'put', 'patch']:
                    ...
                    if 'multipart/form-data' in content:
                        ...
                        assert any(k in multipart_schema for k in ['properties', 'allOf', '$ref', 'oneOf', 'anyOf']), \
