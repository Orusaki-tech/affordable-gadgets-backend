...
def test_receipt_generation(order_id_str):
    ...
    try:
        ...
        try:
            ...
            print("ℹ️  Receipt already exists:")
            ...
            print("ℹ️  No existing receipt found")
        ...
        try:
            ...
            if "AFFORDABLE GADGETS" in html_content:
                print("✅ Contains company name")
            if receipt_number in html_content:
                print("✅ Contains receipt number")
            if str(order.total_amount) in html_content:
                print("✅ Contains order amount")
