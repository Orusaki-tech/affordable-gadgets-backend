...
print(
    f"   CLOUDINARY_API_SECRET: {'SET' if os.environ.get('CLOUDINARY_API_SECRET') else 'NOT SET'}"
)
...
if promotion.banner_image:
    ...
    if is_cloudinary:
                ...
                if "," in after_upload or "c_fill" in after_upload:
                    ...
                    if parts_after_transform:
                        ...
                        try:
                            ...
                            transformed_url = cloudinary_img.build_url(
                                transformation=[
                                    {
                                        "width": 1080,
                                        "height": 1920,
                            ...
                            try:
                                ...
                                with urllib.request.urlopen(
                                    ...
                                    if response.getcode() == 200:
                                        print("   ✅ Transformed URL is accessible")
                                    else:
                                        print(
                                            f"   ❌ Transformed URL returned: {response.getcode()}"
                                        )
                            except Exception as e:
        ...
        print("   This is a local URL, not Cloudinary")
        print("   The image may have been uploaded before Cloudinary was configured")
        print("   Or Cloudinary storage is not working correctly")
            ...
            try:
                ...
                try:
                    ...
                    with urllib.request.urlopen(req, timeout=5, context=ssl_context) as response:
                        if response.getcode() == 200:
                            print("   ✅ Constructed URL is accessible")
                        else:
