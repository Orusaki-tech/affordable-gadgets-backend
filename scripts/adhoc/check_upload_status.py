                    ...
                    if banner_image:
                        ...
                        if public_id:
                            ...
                            if public_id.startswith("media/"):
                                print("   ✅ Has 'media/' prefix")
                            else:
                                print("   ❌ Missing 'media/' prefix")
                            ...
                            if found_url:
                                ...
                                print("   ❌ Image not found at any variation")
                                print("\n   💡 Possible issues:")
                                print("      1. File upload failed silently")
                                print("      2. File is at a different path")
                                print("      3. Filename is different")
                                print("\n   📋 Check Render logs for:")
                                print(
                                    "      'DEBUG: Banner image after save - URL: ..., Name: ...'"
                                )
                                print(
                                    "      This will show what banner_image.name actually contains"
                                )
                    else:
                        print("\n   ❌ No banner image URL")
