                ...
                if "results" in data and len(data["results"]) > 0:
                    for promotion in data["results"]:
                        if promotion.get("id") == 2:
                            banner_url = promotion.get("banner_image") or promotion.get(
                                "banner_image_url"
                            )
                            ...
                            if banner_url and "cloudinary.com" in banner_url:
                                ...
                                try:
                                    ...
                                    if public_id.startswith("media/"):
                                        ...
                                        print("   ❌ This is wrong - should be 'promotions/...'")
                                        ...
                                        try:
                                            ...
                                            with urllib.request.urlopen(
                                                ...
                                                if img_response.getcode() == 200:
                                                    print(
                                                        f"   ✅ Correct URL works! Image exists at: {correct_public_id}"
                                                    )
                                                else:
                                                    print(
                                                        f"   ❌ Correct URL also returns: {img_response.getcode()}"
                                                    )
                                    ...
                                    print("   ⚠️  Could not parse URL structure")
