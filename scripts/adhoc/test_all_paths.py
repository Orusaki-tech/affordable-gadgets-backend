...
test_urls = [
    ...
    (
        ...
        "Original (no media/, with transformations)",
    ),
    ...
    (
        ...
        "No media/, with version and transformations",
    ),
    # With media/ prefix
    ...
    (
        f"{base_url}/{transformations}/v1/{media_public_id_base}",
        "With media/, with version and transformations",
    ),
    # Try different filename variations
    (
        f"{base_url}/{transformations}/v1/media/promotions/2026/01/IPHONE14PROMAX.auto",
        "With .auto extension",
    ),
    (
        f"{base_url}/{transformations}/v1/media/promotions/2026/01/IPHONE14PROMAX.jpg",
        "With .jpg extension",
    ),
    (
        f"{base_url}/{transformations}/v1/media/promotions/2026/01/IPHONE14PROMAX.png",
        "With .png extension",
    ),
    # Try lowercase
    (
        f"{base_url}/{transformations}/v1/media/promotions/2026/01/iphone14promax",
        "Lowercase filename",
    ),
    (
        f"{base_url}/{transformations}/v1/media/promotions/2026/01/iphone14promaxxx_mxptk2",
        "Original filename",
    ),
]
