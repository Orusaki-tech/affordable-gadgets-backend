...
if os.path.exists("store/settings.py"):
    with open("store/settings.py") as f:
        content = f.read()
...
if os.path.exists("inventory/models.py"):
    ...
    if (
        "os.environ.get('CLOUDINARY_CLOUD_NAME'" in content
        or "getattr(settings, 'CLOUDINARY_CLOUD_NAME'" in content
    ):
    ...
    if (
        "os.environ.get('CLOUDINARY_API_KEY'" in content
        or "getattr(settings, 'CLOUDINARY_API_KEY'" in content
    ):
    ...
    if (
        "os.environ.get('CLOUDINARY_API_SECRET'" in content
        or "getattr(settings, 'CLOUDINARY_API_SECRET'" in content
    ):
