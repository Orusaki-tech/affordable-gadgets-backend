            ...
            if response.getcode() == 200:
                ...
                if "results" in data and len(data["results"]) > 0:
                    ...
                    if banner_image and "media/" in banner_image:
                        print("   ✅ URL has 'media/' prefix")
                    else:
                        print("   ❌ URL missing 'media/' prefix")
                    ...
                    if banner_image:
                        ...
                        test_urls = [
                            ...
                            (
                                test_url.replace("/v1/promotions/", "/v1/media/promotions/"),
                                "With media/ prefix",
                            ),
                            (
                                test_url.replace("/v1/promotions/", "/media/promotions/"),
                                "With media/, no version",
                            ),
                        ]
                        ...
                        for url_to_test, desc in test_urls:
                            try:
                                ...
                                with urllib.request.urlopen(
                                    req_test, timeout=5, context=ssl_context
                                ) as resp:
                                    if resp.getcode() == 200:
